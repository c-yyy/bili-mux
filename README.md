...
一个 Manifest V3 Chrome 扩展，在 B站视频页注入下载面板，支持封面下载、复制封面、DASH 音视频流分离保存、浏览器内 ffmpeg.wasm 合成 MP4、FLV 合并下载。
...
| 复制封面 | 一键将封面图复制到剪贴板（优先复制图片本身，受限则降级复制链接） |
...
5. **复制封面**：点击「复制封面」，封面图直接进剪贴板（可粘贴到聊天/编辑器）；若环境受限则降级复制封面链接。
