...
[⬇️ Download Bili-Mux v1.1.1 (.crx)](https://github.com/c-yyy/bili-mux/raw/main/Bili-Mux-v1.1.1.crx)
...
2. Drag the downloaded `Bili-Mux-v1.1.1.crx` onto the page and click "Add extension".
